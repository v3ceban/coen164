...
# Controller for the lineitems
class LineitemsController < ApplicationController
  before_action :set_cart # set @cart for this user
  ...
  def create
    ...
    # use @cart and product_id to build lineitems row
  ...
  private
    ...
    def lineitem_params
      params.require(:lineitem).permit(:cart_id, :product_id)
    end
end
